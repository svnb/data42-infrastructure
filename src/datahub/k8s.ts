...
export class DatahubK8sComponent extends pulumi.ComponentResource {
  ...
  constructor(
    ...
    this.neo4jSecret = new k8s.core.v1.Secret(
      "neo4j",
      {
        type: "Opaque",
        metadata: {
    ...
    const prerequisitesChart = new k8s.helm.v3.Chart(
      "prerequisites",
      {
        namespace: this.namespace.metadata.name,
        path: CHARTS_PATH,
      ...
      { parent: this, dependsOn: this.mysqlSecret },
    ); // mysql deployment automatically referes this secret
